...
def priority(init_processes):
    ...
    while(len(finished_processes) < total_length):
        ...
        # sets any arrived processes as active if there are no active processes
        active_process = sf.npe_next_process('priority', active_process, arrived_processes)
...
def srpt(init_processes):
    ...
    while(len(finished_processes) < total_length):
        ...
        # sets any arrived processes as active if there are no active processes
        active_process = sf.srpt_next_process('srpt', active_process, arrived_processes)
...
def round_robin(init_processes):
    ...
    while(len(finished_processes) < total_length):
        ...
        # handles logic for when processes should swap
        active_process = sf.rr_next_process('rr', active_process, arrived_processes, time_elapsed)
